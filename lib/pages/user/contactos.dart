                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Row(
                          children: [
                            Icon(Icons.phone,
                                color: Color(0xFF0076bc)), // Icono de teléfono
                            SizedBox(width: 8),
                            Text(
                                'Teléfono: +593 979274126'), // Número de teléfono
                          ],
                        ),
                        ...
                        const Row(
                          children: [
                            Icon(Icons.email,
                                color: Color(0xFF0076bc)), // Icono de email
                            SizedBox(width: 8),
                        ...
                        const Row(
                          children: [
                            Icon(Icons.location_on,
                                color: Color(0xFF0076bc)), // Icono de dirección
                            SizedBox(width: 8),
                            Text(
                                'Dirección: Serrano y Luis Cordero, Azogues'), // Dirección
                          ],
                        ),
                      ],
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            maxLines:
                                3, // Permite varias líneas para la opinión
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                          ...
                          Center(
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    const Color(0xFF0076bc), // Color del botón
                              ),
                              child: const Text(
                                'Enviar',
                                style: TextStyle(
