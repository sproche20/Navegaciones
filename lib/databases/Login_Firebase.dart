...
import 'package:navegaciones/pages/user/inicio.dart';
  ...
  Future<void> loginUsuario(
    ...
    try {
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const Inicio()), // Redirige a la página de inicio
                );
              },
              ...
              onPressed: () {
                ...
                if (email == 'softech@gmail.com') {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const PaginaUsuario()),
                  );
                }
              },
              child: const Text('Aceptar'),
      ...
      if (e.code == 'user-not-found') {
        errorMessage =
            'No hay un usuario registrado con este correo electrónico';
